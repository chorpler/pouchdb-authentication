        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, fetch(newurl, nFetchOpts)];
                case 3:
...
export default plugin;
export { getConfigUrl, getMembership, deleteAdmin, signUpAdmin, logIn, logOut, getSession, getUsersDatabaseUrl, signUp, getUser, putUser, deleteUser, changePassword, changeUsername, mode, fet, nFetch, debuglog, debuglogemph, debugloggroup, debugloggroupend, debugerr, AuthError, doFetch, getBasicAuthHeadersFor, getBasicAuthHeaders, getBaseUrl, getComplexBaseUrl, getRelativeComplexUrl, makeBaseUrl, getURLWithoutSearchParams };
